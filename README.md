...
点击「添加文件」添加文件后，选中文件会在右侧面板**实时显示**所有隐藏元数据，无需额外操作。点击「清除元数据」一键清除。

**双栏布局**：左侧文件列表，右侧元数据面板，选中文件自动展示。窗口大小和分栏比例自动记忆。
...
2. 选中文件 → **右侧面板自动显示**元数据，核对文件中的隐藏信息
