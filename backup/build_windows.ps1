...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "|                                              |"
    Write-Host "| dist\MetadataCleaner.exe                     |"
    Write-Host "|                                              |"
    Write-Host "| Single .exe file, run directly on any        |"
    Write-Host "| Windows PC, no Python needed.                |"
    Write-Host "+==============================================+"
    Write-Host ""
    Write-Host "Output: $ScriptDir\dist\MetadataCleaner.exe"
} else {
    Write-Host ""
